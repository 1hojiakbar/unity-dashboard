    ...
    <div className="flex flex-col w-full">
      <nav className="flex items-center justify-between w-full">
        ...
        <div className="flex justify-end w-1/4">
          <div className="p-2 relative cursor-pointer">
            ...
            <img className="w-7" src={bellIcon} alt="icon not found" />
          </div>
        </div>
      </nav>
      <div className="flex items-center justify-center mt-10 h-max bg-white">
        <div className="bg-white rounded-xl shadow-2xl p-6 w-80 text-center py-12">
          <h2 className="text-gray-500 mb-2">Your earning this month</h2>
          <p className="text-5xl font-bold text-purple-600 mb-4">479.4</p>
          <p className="text-gray-400 mb-6">
            Update your payout method in Settings
          </p>
          <button className="bg-white text-active-color py-2 px-4 rounded-xl transition-all ease-linear hover:bg-active-color hover:text-white outline-none">
